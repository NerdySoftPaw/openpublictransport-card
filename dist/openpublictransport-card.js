...
`,ft={layout:"table",max_departures:10,show_header:!0,show_platform:!0,show_delay:!0,show_realtime_indicator:!0,theme:"auto"},mt={bus:"mdi:bus",tram:"mdi:tram",subway:"mdi:subway-variant",train:"mdi:train",ferry:"mdi:ferry",taxi:"mdi:taxi","s-bahn":"mdi:train","u-bahn":"mdi:subway-variant",regional:"mdi:train",express:"mdi:train",default:"mdi:transit-connection-variant"};let _t=class extends at{constructor(){super(...arguments),this.delay=0,this.isRealtime=!1}render(){return this.delay>0?q`
    ...
    `}};vt.styles=gt,t([ht({attribute:!1})],vt.prototype,"hass",void 0),t([ht({attribute:!1})],vt.prototype,"config",void 0),t([ht({attribute:!1})],vt.prototype,"departures",void 0),t([ht({type:String})],vt.prototype,"stationName",void 0),vt=t([ct("openpublictransport-compact-layout")],vt);let wt=class extends at{constructor(){super(...arguments),this.trip=null}_formatTime(t){try{return new Date(t).toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}catch{return t}}_getRiskClass(t){switch(t.toLowerCase()){case"low":return"risk-low";case"medium":return"risk-medium";case"high":return"risk-high";default:return""}}_getRiskIcon(t){switch(t.toLowerCase()){case"low":return"mdi:check-circle";case"medium":return"mdi:alert";case"high":return"mdi:alert-octagon";default:return"mdi:help-circle"}}_renderHeader(t){return this.config.show_header?q`
    ...
    `:q`<div class="card-empty">No trip data available</div>`}};wt.styles=gt,t([ht({attribute:!1})],wt.prototype,"hass",void 0),t([ht({attribute:!1})],wt.prototype,"config",void 0),t([ht({attribute:!1})],wt.prototype,"trip",void 0),wt=t([ct("openpublictransport-trip-layout")],wt);let xt=class extends at{setConfig(t){this._config={...ft,...t}}_fireConfigChanged(){const t=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(t)}_entityChanged(t){this._config&&t.detail.value&&(this._config={...this._config,entity:t.detail.value},this._fireConfigChanged())}_layoutChanged(t){this._config&&t.detail.value&&(this._config={...this._config,layout:t.detail.value},this._fireConfigChanged())}_themeChanged(t){this._config&&t.detail.value&&(this._config={...this._config,theme:t.detail.value},this._fireConfigChanged())}_maxDeparturesChanged(t){if(!this._config)return;const e=t.target,i=parseInt(e.value,10);isNaN(i)||i<1||(this._config={...this._config,max_departures:i},this._fireConfigChanged())}_toggleChanged(t){return e=>{this._config&&(this._config={...this._config,[t]:e.target.checked},this._fireConfigChanged())}}render(){return this.hass&&this._config?q`
  ...
  `,t([ht({attribute:!1})],xt.prototype,"hass",void 0),t([ut()],xt.prototype,"_config",void 0),xt=t([ct("openpublictransport-card-editor")],xt),console.info("%c OPENPUBLICTRANSPORT-CARD %c v1.0.0 ","color: #ffd700; background: #1a1a1a; font-weight: bold; padding: 2px 4px;","color: #1a1a1a; background: #ffd700; font-weight: bold; padding: 2px 4px;");let At=class extends at{static getConfigElement(){return document.createElement("openpublictransport-card-editor")}static getStubConfig(){return{entity:"",...ft}}setConfig(t){if(!t.entity)throw new Error("Please define an entity");this._config={...ft,...t}}getCardSize(){if(!this._config)return 3;switch(this._config.layout){case"compact":return 2;case"trip":return 5;default:return Math.min(2+(this._config.max_departures||10),12)}}connectedCallback(){super.connectedCallback(),this._timeInterval=setInterval(()=>{this.requestUpdate()},3e4)}disconnectedCallback(){super.disconnectedCallback(),this._timeInterval&&(clearInterval(this._timeInterval),this._timeInterval=void 0)}updated(t){super.updated(t),this._applyTheme()}_applyTheme(){if(!this._config)return;let t=this._config.theme;"auto"===t&&(t=this.hass?.themes?.darkMode?"dark":"light"),this.setAttribute("data-theme",t)}_getDepartures(){if(!this.hass||!this._config)return[];const t=this.hass.states[this._config.entity];if(!t)return[];const e=t.attributes.departures;return Array.isArray(e)?e:[]}_getTripData(){if(!this.hass||!this._config)return null;const t=this.hass.states[this._config.entity];if(!t)return null;const e=t.attributes.trip;return e||null}_getStationName(){if(!this.hass||!this._config)return"";const t=this.hass.states[this._config.entity];return t?t.attributes.friendly_name||t.attributes.station_name||t.entity_id:""}_renderError(t){return q`
      <ha-card>
